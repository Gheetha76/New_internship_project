...
# behave -f allure_behave.formatter:AllureFormatter -o test_results/ features/tests/Amazon_best_sellers.feature
...
# def browser_init(context, scenario_name):  # add scenario_name if you want to use it in Browserstack
    ...
    # context.driver.set_window_size(1920, 1080)
     ...
     # service = Service(executable_path='/Users/Gheethvijay/Downloads/Gheetha_internship_project/browserstack.yml')
